          ...
          {agents.map((agent) => (
            ...
            >
              ...
              <div className="relative w-20 h-20 mx-auto mb-4">
                ...
                {/* Verified Badge */}
                <span className="absolute bottom-0 right-0 bg-white text-black text-xs px-2 py-0.5 rounded-full">
                  ✔
                </span>
              </div>
              ...
              <div className="flex justify-center gap-2 mt-4">
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="border-gray-500 text-black hover:text-white hover:border-white flex items-center gap-1"
                >
                  <FaWhatsapp />
                </Button>
              </div>
...
//           <div className="grid md:grid-cols-4 gap-8">
//             {[...Array(4)].map((_, i) => (
//               <Skeleton key={i} className="h-64 rounded-3xl bg-gray-800" />
//             ))}
//           </div>
//         )}
...
//                     />
//                   ) : (
//                     <div className="w-full h-full rounded-full bg-white/20 border border-white/30 flex items-center justify-center text-2xl font-bold text-white">
